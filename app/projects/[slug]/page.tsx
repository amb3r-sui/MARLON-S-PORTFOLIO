    ...
    <article>
      ...
      <div className="container case-layout">
        <main className="case-main">
          ...
          {project.demoMode === "simulation" && project.demoScenarios.length > 0 && <CaseSection eyebrow="Interactive demonstration" title="Try the workflow safely"><p>This browser-only simulation uses predefined sample data and never connects to n8n, localhost, credentials, or external business systems.</p><WorkflowDemo project={project} /></CaseSection>}
