...
import { ArrowRight, CheckCircle2, Github, Linkedin, Radio } from "lucide-react";
    ...
    <section className="hero">
      <div className="container hero-grid">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .55 }} className="hero-copy">
          ...
          <div className="hero-links"><ResumeButton compact /><a href={profile.linkedIn} target="_blank" rel="noreferrer"><Linkedin size={16} /> LinkedIn</a><a href={profile.github} target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a></div>
        </motion.div>
